...
<p>Flamey groaned. He wouldn’t have signed up for this class if he had a choice. It was known to be dull and perplexing. Why did he have to learn about the old languages from the Controlled Age that ancient computers used to speak? The textbook listed a lot of strange names like Binary, Assembly, C, Python, Javascript blah blah. They went extinct 500 years ago!</p>

<p>They entered the room through a glass door, where Prof. Evergreen was sitting behind his desk with lots of empty chairs. As expected, they were the only two students today.</p>
...
<p>“What if a number system’s base is larger than ten? Don’t we run out of numbers to use?” Flamey quickly found a way to argue - how can you blame him? As his brain cpu is set to teenage mode, argument is his specialty.</p>

<p>“You can invent more symbols beyond 0 to 9, or just reuse existing symbols, like letters.” Prof. Evergreen replied as he had heard of this question millions of times. “For example, the 16-based number system (Hex), which is also very popular, uses: A for ten, B for eleven, C for twelve, D for thirteen, E for fourteen and F for fifteen.”</p>

<p>“Oh…” Flamey was a little disappointed that his question was answered so easily.</p>

<p>“Once we run out of single symbols – whatever the number is - we are going to combine them to build more complicated numbers. “ Prof. Evergreen continued, “Remember Place Value that you learned at Elementary school? It is the value of each digit in a number based on its position. Here is the second rule of a number system,” Prof. Evergreen casted another slide in the air:</p>

<img/>

<p>“Wow!” said Starlaxverse, not sure she was complimenting the rule or the cats on the slides wearing place value shirts.</p>

<p>“Oh, it starts to make sense now.” As immune to any cuteness as he can be, Flamey found something: “So you can convert a binary number into decimal by adding up those parts.”</p>

<p>“Good find.” Nodded Prof. Evergreen, ”But we ran out of time. As science has shown, your attention must be depleted now.” Prof. Evergreen walked out of the room in a rush without even acknowledging his two students.</p>

<p>“Hmm…” Starlaxverse looked at Flamey with a puzzled look, “He is definitely a man with character, but not the way I expected.”</p>

<p>“Yep.” Answered Flamey, “Don’t think he overused cats to make a point?”</p>

<p>“Nope”, Said Starlaxverse, “There is no such thing as too many cats.”</p>
